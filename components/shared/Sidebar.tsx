            ...
            <DropdownMenu>
              <DropdownMenuTrigger className="flex min-h-10 w-full items-center gap-3 p-4 text-left transition-colors hover:bg-accent/50 focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50">
                  {company?.logo_url ? (
                    ...
                    <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-linear-to-br from-blue-500/20 to-blue-500/10 shrink-0">
                  ...
                  return (
                    ...
                    >
                      {c.company_logo_url ? (
                        ...
                        <div className="flex h-7 w-7 items-center justify-center rounded-md bg-linear-to-br from-blue-500/15 to-blue-500/5 text-primary text-xs font-bold shrink-0">
        ...
        <div className="flex flex-col gap-1 p-3 flex-1">
          {myCompanies.length === 0 ? (
            <div className="rounded-xl border border-dashed border-border/60 p-4 text-sm text-muted-foreground">
              ...
              <Link href="/companies/new" className="mt-3 inline-flex items-center text-primary hover:text-primary-hover">
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  isActive
                    ? 'bg-primary-light text-primary-text shadow-sm border border-primary-border/60'
